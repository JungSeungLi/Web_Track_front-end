            ...
            <div id="section">
                ...
                <div id="lesson_center">
                    ...
                    <div id="jb_sidebar_left">
                        <div class="left_menu">
                            <ul>
                                <li class="click"><a href="./Lesson_ymbol.php">공지사항</a></li>
                                <li><a href="./educational_objectives.php">일정달력</a></li>
                                <li><a href="./facilities.php">교내행사영상</a></li>
                                <li><a href="./directions.php">교내행사사진</a></li>
                            </ul>
                        </div>
                    </div>
                    <div id="jb_content">
